        ...
        <div className="mb-6">
          ...
          <ul>
            ...
            <li>
              <button
                className={`w-full text-left py-2 px-3 rounded ${
                  activeCategory === "basic" ? "bg-blue-100 text-blue-700" : "hover:bg-gray-100"
                }`}
                onClick={() => {
            ...
            <li>
              <button
                className={`w-full text-left py-2 px-3 rounded ${
                  activeCategory === "advanced" ? "bg-blue-100 text-blue-700" : "hover:bg-gray-100"
                }`}
                onClick={() => {
              ...
              {tiers
                ...
                .map((tier) => (
                  <li key={tier}>
                    <button
                      className={`w-full text-left py-2 px-3 rounded ${
                        activeCategory === `tier-${tier}` ? "bg-blue-100 text-blue-700" : "hover:bg-gray-100"
                      }`}
                      onClick={() => {
        ...
        <div className="mb-6 flex flex-col sm:flex-row items-stretch sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex border border-gray-300 rounded-lg overflow-hidden">
              <button
                className={`px-3 py-2 ${viewMode === "grid" ? "bg-blue-100 text-blue-700" : "bg-white text-gray-700"}`}
              ...
              <button
                className={`px-3 py-2 ${viewMode === "list" ? "bg-blue-100 text-blue-700" : "bg-white text-gray-700"}`}
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow p-8 text-center">
            ...
            <p className="mt-1 text-gray-500">
              {search ? `No elements matching "${search}"` : "Try adjusting your filter criteria."}
            </p>
          </div>
        ) : (
          <>
                      ...
                      <tr
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">
                            {element.recipes_to_make_this_element && element.recipes_to_make_this_element.length > 0
                              ? `${element.recipes_to_make_this_element.length} recipe(s)`
                              : "Basic element"}
                          </div>
                        </td>
                      </tr>
            ...
            {sortedElements.length > 0 && (
              <div className="mt-4 text-center text-sm text-gray-600">
                Showing {indexOfFirstItem + 1}-{Math.min(indexOfLastItem, sortedElements.length)} of {sortedElements.length}{" "}
                elements
              </div>
            )}
          </>
          ...
          <div className="bg-white rounded-lg shadow-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center">
                  <img
                    src={selectedElement.image_path}
                    alt={selectedElement.name}
                    className="w-24 h-24 object-contain bg-gray-200 p-3 rounded-lg mr-4 shadow-sm"
                  />
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900">{selectedElement.name}</h2>
                    <div className="flex flex-wrap gap-2 mt-2">
                      <span className="text-sm px-2 py-1 bg-blue-100 text-blue-800 rounded-full">
                        Tier {selectedElement.tier}
                      </span>
                      {isElementConsideredBasic(selectedElement) && (
                        <span className="text-sm px-2 py-1 bg-purple-100 text-purple-800 rounded-full">Basic Element</span>
                      )}
                    </div>
                  </div>
                </div>
                        ...
                        <div
                          ...
                          <div className="flex items-center justify-center">
                            ...
                            <div className="flex flex-col items-center">
                              ...
                              <span
                                className="text-xs font-medium mt-1 text-center max-w-[80px] truncate"
                                title={recipe.element_one}>
                                {recipe.element_one}
                              </span>
                            </div>
                ...
                <div className="mt-4 bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      {selectedElement.Name === "Time" && (
                        <p className="text-sm text-yellow-700 mt-1">Unlock 100 elements to discover the Time element.</p>
                      )}
                    </div>
                  </div>
                </div>
                        ...
                        <div
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="text-sm font-medium">
                              {recipe.element_one === selectedElement.name ? recipe.element_two : recipe.element_one}
                            </span>
                          </div>
                          <div className="flex items-center">
